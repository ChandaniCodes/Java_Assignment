...
class Department{
	...
	// public void sendMail(Employee []empObj){
	// 	for(Employee emp:empObj)
	// 		System.out.println("Mail is sent to " + emp.emp_name);
	// }
}
...
public class Test{
	...
	public static void main(String[] args) {
		...
		// System.out.println("11 .Send mail to the employee");
		// System.out.println("12 .Send mail to the front-end department");
		// System.out.println("13 .Send mail to the back-end department");
		...
		do{
			...
			switch(choice){
				...
				// case 11: System.out.println("Enter employee name");
